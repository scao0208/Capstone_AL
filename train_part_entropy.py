...
class LitAutoTrain(L.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if isinstance(val_entropy, int):
            val_entropy = 0
        else:
            val_entropy = val_entropy.item()
        ...
        val_map['my_map_50'], val_map['val_entropy'],  = val_map50, val_entropy
...
check_best=ModelCheckpoint(
    ...
    monitor="val_entropy",
    mode="min",
    dirpath="./lightning_logs/entropy_ckpt",
